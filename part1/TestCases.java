...
public class TestCases
{
   ...
   public void testSimpleIf3()
   {
      ...
      assertEquals(8.7, SimpleIf.max(1.2, 8.7), DELTA);
   }
   ...
   public void testSimpleArray3()
   {
      ...
      assertArrayEquals(
         new int[] {100, 4},
         SimpleArray.squareAll(new int[] {10, 2}));
   }
   ...
   public void testSimpleList2()
   {
      ...
      List<Integer> input =
         new LinkedList<Integer>(Arrays.asList(new Integer[] {5, 6}));
      List<Integer> expected = 
         new ArrayList<Integer>(Arrays.asList(new Integer[] {25, 36}));
   ...
   public void testExampleMap2()
   {
      ...
      courseListsByStudent.put("Aimee",
         Arrays.asList(
            new Course("CPE 101", 4),
            new Course("CPE 202", 4),
